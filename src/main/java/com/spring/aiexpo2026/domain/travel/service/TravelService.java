...
public interface TravelService {
	...
	ApiResponse<StartTravelResponse> startTravel(
	...
	ApiResponse<EditTravelResponse> editTravel(
			HttpServletRequest servletRequest,
			Long id,
	...
	ApiResponse<AttractionsResponse> attractionsHistory(
	...
	List<GetAttractionsResponse> getAttractionsHistory(
			HttpServletRequest httpServletRequest,
			Long travelId
	);
}